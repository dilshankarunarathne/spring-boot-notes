...
Say that we have a data layer for multiple use cases. We can expose only those implementations necessary, for a given use case in code, avoiding the noise of those use cases that don't 