...
With a defined web URL, a web request will come to our application. And the MVC framework of whatever the technology we're using, in our case Spring - will pick the controller and the method