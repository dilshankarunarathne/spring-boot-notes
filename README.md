...
Spring can even respond to except header, if we need to support multiple content types within our application - as long as we have a marshaller and an unmarshaller configured in the Application Context.  
