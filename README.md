...
Usually, both of these (Model & View) are then passed by the MVC framework to the templating engine, which merges the model's data elements with the placeholders