...
Essentially, it is an interface that leverages proxies to build the actual CRUD methods. We can decorate this interface for our own queries by adding methods with conventional names 
* 