...
We usually do not interact with the Bean Factory directly. But, if we ever find ourself in a situation where we have to impact the behaviour of the Bean Factory, we can utilize various hooks in the Spring Bean life-cycle, things like a Bean Factory post processor