...
The proxy classes have to be called through the proxy itself for the behaviour to be added. This is important when dealing with private method calls or class local method calls. Data access for instance, with transactions  