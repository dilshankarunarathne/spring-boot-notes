...
Even if we don't do it ourself by writing code. Many times this isn't even needed because of the way that Spring Boot does its things. But the Application Context is a 