...
With Spring, there's a specialized controller for RESTFul web services. In reality, it's a stereotype of controller that adds response body to each method