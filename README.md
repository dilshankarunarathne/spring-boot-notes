...
Once we have our service implementation and the dependencies along with the API, we should then annotate or configure our classes to be managed by Spring. 